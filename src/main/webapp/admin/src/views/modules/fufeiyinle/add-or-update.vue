  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="歌名" prop="geming">
              <el-input v-model="ruleForm.geming" 
                placeholder="歌名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="音乐标签" prop="yinlebiaoqian">
          <el-select v-model="ruleForm.yinlebiaoqian" placeholder="请选择音乐标签">
            <el-option
                v-for="(item,index) in yinlebiaoqianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="音乐标签" prop="yinlebiaoqian">
	      <el-input v-model="ruleForm.yinlebiaoqian"
                placeholder="音乐标签" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="演唱者" prop="yanchangzhe">
          <el-input v-model="ruleForm.yanchangzhe" 
              placeholder="演唱者" clearable  :readonly="ro.yanchangzhe"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="演唱者" prop="yanchangzhe">
              <el-input v-model="ruleForm.yanchangzhe" 
                placeholder="演唱者" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作曲" prop="zuoqu">
          <el-input v-model="ruleForm.zuoqu" 
              placeholder="作曲" clearable  :readonly="ro.zuoqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作曲" prop="zuoqu">
              <el-input v-model="ruleForm.zuoqu" 
                placeholder="作曲" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作词" prop="zuoci">
          <el-input v-model="ruleForm.zuoci" 
              placeholder="作词" clearable  :readonly="ro.zuoci"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作词" prop="zuoci">
              <el-input v-model="ruleForm.zuoci" 
                placeholder="作词" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="音乐视频" prop="yinleshipin">
          <file-upload
          tip="点击上传音乐视频"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.yinleshipin?ruleForm.yinleshipin:''"
          @change="yinleshipinUploadChange"
          ></file-upload>
        </el-form-item> 
        <div v-else>
          <el-form-item v-if="ruleForm.yinleshipin" label="音乐视频" prop="yinleshipin">
            <el-button type="text" size="small" @click="download(ruleForm.yinleshipin)">预览</el-button>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="价格" prop="jiage">
              <el-input v-model="ruleForm.jiage" 
                placeholder="价格" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="试听片段" prop="shitingpianduan">
          <file-upload
          tip="点击上传试听片段"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.shitingpianduan?ruleForm.shitingpianduan:''"
          @change="shitingpianduanUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.shitingpianduan" label="试听片段" prop="shitingpianduan">
            <el-button type="text" size="small" @click="download(ruleForm.shitingpianduan)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
                                                                                                                        </el-row>
                                                                                                                                                                                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="歌曲介绍" prop="gequjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.gequjieshao" label="歌曲介绍" prop="gequjieshao">
                    <span v-html="ruleForm.gequjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.geming = true;
            continue;
	            	            ...
	            	            if(o=='yinlebiaoqian'){
            this.ruleForm.yinlebiaoqian = obj[o];
	    this.ro.yinlebiaoqian = true;
            continue;
          }
	            	            if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='yanchangzhe'){
            this.ruleForm.yanchangzhe = obj[o];
	    this.ro.yanchangzhe = true;
            continue;
          }
	            	            if(o=='zuoqu'){
            this.ruleForm.zuoqu = obj[o];
	    this.ro.zuoqu = true;
            continue;
          }
	            	            if(o=='zuoci'){
            this.ruleForm.zuoci = obj[o];
	    this.ro.zuoci = true;
            continue;
          }
	            	            if(o=='yinleshipin'){
            this.ruleForm.yinleshipin = obj[o];
	    this.ro.yinleshipin = true;
            continue;
          }
	            	            if(o=='jiage'){
	    ...
	    this.ro.jiage = true;
            continue;
	            	            ...
	            	            if(o=='shitingpianduan'){
            this.ruleForm.shitingpianduan = obj[o];
	    this.ro.shitingpianduan = true;
            continue;
          }
	            	            if(o=='gequjieshao'){
    ...
    back() {
      ...
      this.parent.contentStyleChange();
				...
				this.addEditUploadStyleChange()
                                                                    ...
                                                                    yinleshipinUploadChange(fileUrls) {
                this.ruleForm.yinleshipin = fileUrls;
				this.addEditUploadStyleChange()
            },
                                            shitingpianduanUploadChange(fileUrls) {
                this.ruleForm.shitingpianduan = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
