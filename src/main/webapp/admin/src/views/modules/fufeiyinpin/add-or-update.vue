  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="歌名" prop="geming">
              <el-input v-model="ruleForm.geming" 
                placeholder="歌名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="音乐标签" prop="yinlebiaoqian">
          <el-input v-model="ruleForm.yinlebiaoqian" 
              placeholder="音乐标签" clearable  :readonly="ro.yinlebiaoqian"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="用户名" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming" 
                placeholder="用户名" readonly></el-input>
                                    ...
                                    <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="音频" prop="yinpin">
          <file-upload
          tip="点击上传音频"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.yinpin" label="音频" prop="yinpin">
            <el-button type="text" size="small" @click="download(ruleForm.yinpin)">预览</el-button>
          </el-form-item>
        </div>    
      </el-col>
                              </el-row>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fufeiyinpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fufeiyinpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
